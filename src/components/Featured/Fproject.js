...
import pic from "./images/expensify.PNG";
import pic2 from "./images/e2.PNG";
import s1 from "./images/react.svg";
import s2 from "./images/redux.svg";
import s3 from "./images/firebase.svg";
                ...
                <div className="content">
                    <div className="title">
                        ...
                        <div className="title-t2">
                            <p className="text t2">Expensify</p>
                        </div>
                    </div>

                    <div className="description">
                        <p className="d-text">
                        A web app to help manage and track any purchases
                        that you have made or are planning to make in the
                        future to ensure all your expenses are accounted for.
                        Budgeting reimagined to optimize the management of 
                        spending habits.
                        </p>
                    </div>
                    ...
                    <div className="stack">
                        ...
                        <div className="skill two">
                            ...
                            <p className="s">Redux</p>
                        </div>
                        <div className="skill three">
                            <img src={s3} alt="" className="logo"/>
                            <p className="s">Firebase</p>
                        </div>
                    </div>

                    <div className="links">
                        <a href="https://github.com/dhruv-patel1/expensify-app" className="link">
                            <img src={s4} alt="" className="svg"/>
                        </a>
                        <a href="https://reactexpensify-app.herokuapp.com/" className="link">
